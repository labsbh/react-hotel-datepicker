...
var DayWrapper = styled.td(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  background-color: ", ";\n  color: ", ";\n  padding: ", ";\n  ", "\n\n  &.valid {\n    cursor: pointer;\n  }\n\n  &.no-checkin {\n    color: ", ";\n    position: relative;\n\n    &:after {\n      background-color: ", ";\n      bottom: 0;\n      content: '';\n      display: block;\n      left: 50%;\n      position: absolute;\n      right: 0;\n      top: 0;\n      z-index: -1;\n    }\n  }\n\n  &.no-checkout {\n    color: ", ";\n    position: relative;\n\n    &:after {\n      background-color: ", ";\n      bottom: 0;\n      content: '';\n      display: block;\n      left: 0;\n      position: absolute;\n      right: 50%;\n      top: 0;\n      z-index: -1;\n    }\n  }\n\n  &.invalid {\n    background-color: ", ";\n    color: ", ";\n  }\n\n  &.disabled {\n    background-color: ", ";\n    color: ", ";\n    position: relative;\n\n    &:after {\n      content: '\\00d7';\n      left: 50%;\n      position: absolute;\n      color: ", ";\n      font-size: 16px;\n      top: 50%;\n      transform: translate(-50%, -50%);\n    }\n  }\n\n  &.day-of-week-disabled {\n    background-color: ", ";\n    color: ", ";\n  }\n\n  &.today {\n    background-color: ", ";\n    color: ", ";\n  }\n\n  &.type-lastMonth,\n  &.type-nextMonth {\n    visibility: hidden;\n  }\n"], ["\n  background-color: ", ";\n  color: ", ";\n  padding: ", ";\n  ", "\n\n  &.valid {\n    cursor: pointer;\n  }\n\n  &.no-checkin {\n    color: ", ";\n    position: relative;\n\n    &:after {\n      background-color: ", ";\n      bottom: 0;\n      content: '';\n      display: block;\n      left: 50%;\n      position: absolute;\n      right: 0;\n      top: 0;\n      z-index: -1;\n    }\n  }\n\n  &.no-checkout {\n    color: ", ";\n    position: relative;\n\n    &:after {\n      background-color: ", ";\n      bottom: 0;\n      content: '';\n      display: block;\n      left: 0;\n      position: absolute;\n      right: 50%;\n      top: 0;\n      z-index: -1;\n    }\n  }\n\n  &.invalid {\n    background-color: ", ";\n    color: ", ";\n  }\n\n  &.disabled {\n    background-color: ", ";\n    color: ", ";\n    position: relative;\n\n    &:after {\n      content: '\\\\00d7';\n      left: 50%;\n      position: absolute;\n      color: ", ";\n      font-size: 16px;\n      top: 50%;\n      transform: translate(-50%, -50%);\n    }\n  }\n\n  &.day-of-week-disabled {\n    background-color: ", ";\n    color: ", ";\n  }\n\n  &.today {\n    background-color: ", ";\n    color: ", ";\n  }\n\n  &.type-lastMonth,\n  &.type-nextMonth {\n    visibility: hidden;\n  }\n"])), function (props) {
...
var useDayProperties = function () {
    ...
    return useCallback(function (date, type) {
        ...
        var isStartDate = isSameDay(date, startDate);
...
var TopBar = function (_a) {
    ...
    return (jsxs(Wrapper$1, { children: [jsxs(Text, { children: [start && (jsxs(Info, { children: [jsxs(InfoLabel, { children: [t('selected'), "\u00A0"] }, void 0), jsx(InfoText, __assign({ className: "start-day" }, { children: format(start, format$1, { locale: locale }) }), void 0), jsx(InfoText, { children: " - " }, void 0), jsx(InfoText, __assign({ className: "end-day" }, { children: end ? format(end, format$1) : '...' }), void 0), end && (jsxs(InfoText, __assign({ className: "selected-days" }, { children: ["(", t('night', { count: nightCount }), ")"] }), void 0))] }, void 0)), jsx(TopBarFeedback, {}, void 0)] }, void 0), jsx(CloseButton, __assign({ onClick: handleClose }, { children: t('button') }), void 0)] }, void 0));
};
...
var Calendar = function (_a) {
    ...
    var _c = useState(startDate), firstMonth = _c[0], setFirstMonth = _c[1];
    var _d = useState(addMonths(startDate, 1)), secondMonth = _d[0], setSecondMonth = _d[1];
